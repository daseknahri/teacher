...
def _build_notebooklm_checklist_prompt(
    *,
    ...
    prompt_parts = [
        ...
        "- Garde uniquement les headlines visibles; ne reorganise pas l'ordre et ne deplace pas un titre sous un autre titre implicite.",
        "- Si une rubrique generique comme Activites, Contenu de la lecon, Exercices ou Evaluation est visible, garde-la seulement si elle apparait comme un vrai headline du document.",
...
def _build_notebooklm_checklist_review_prompt() -> str:
    return "\n".join(
        [
            ...
            "- Ne reorganise pas l'ordre et ne deplace pas un titre sous un autre titre implicite.",
            "- Si une rubrique generique comme Activites, Contenu de la lecon, Exercices ou Evaluation est visible, garde-la seulement si elle apparait comme un vrai headline du document.",
